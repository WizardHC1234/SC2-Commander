...
# Linux wrapper for tools/strategy_execution_metrics.py
# Examples:
#   ./tools/show_metrics.sh
#   ./tools/show_metrics.sh --input game_records/batch_xxx
#   ./tools/show_metrics.sh --difficulties all
set -euo pipefail
...
TARGET="${SCRIPT_DIR}/strategy_execution_metrics.py"
cd "${REPO_ROOT}"
