...
# Linux wrapper for tools/batch_stats.py (win-rate summary)
# Examples:
#   ./tools/show_winrate.sh
#   ./tools/show_winrate.sh --group-by difficulty
#   ./tools/show_winrate.sh --batch batch_20260812_144059_e1_KairosJunctionL
set -euo pipefail
...
TARGET="${SCRIPT_DIR}/batch_stats.py"
cd "${REPO_ROOT}"
