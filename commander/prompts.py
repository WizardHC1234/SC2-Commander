...
def build_commander_messages(
    *,
    ...
    system_msg = (
        ...
        "You simultaneously handle macro production/tech/expand goals and army zone/mode / scan/scout commands. The written strategy is authoritative. Every executable command is a tool.\n"
        f"\n{_MACRO_EXECUTION_MODEL}\n"
        f"\n{_MACRO_DECISION_ORDER}\n"
        f"\n{_ARMY_ZONE_AND_OUTPUT}\n"
        f"\n{_ARMY_DECISION_RULES}\n"
