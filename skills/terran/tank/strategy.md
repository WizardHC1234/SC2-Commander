...
* Recovery and Cleanup: If an engagement becomes unfavorable, preserve surviving Siege Tanks and withdraw the threatened force to the nearest safe staging position, then merge it with incoming Marines and Tanks. After the first attack begins, do not require the exact 45-Marine and 10-Tank opening composition before every re-engagement; resume the concentrated push when the regrouped force can advance coherently. Search remaining expansions after known enemy bases are destroyed.
